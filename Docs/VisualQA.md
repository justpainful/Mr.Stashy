...
This file must be completed from final simulator screenshots, not from static source inspection.

| Check | Required final evidence | Status |
| --- | --- | --- |
| Device | Current iPhone Pro Max simulator and closest available iPhone 14 Pro Max | Pending final run |
| Locale | English and Arabic RTL | Pending final run |
...
Record concrete issues and fixes below after review. This template intentionally does not assert a completed visual audit.

## Findings

No final screenshot-review run has been recorded in this file.
